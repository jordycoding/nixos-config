...
with lib;
{
  systemd.user.tmpfiles.rules = [
    ...
    "d /home/jordy/.config/dconf-gnome 0755 jordy -"
    "d /home/jordy/.config/dconf-kde 0755 jordy -"
    ...
    "L+ /home/jordy/.config/dconf - - - - /home/jordy/.config/dconf-gnome"
  ] ++ optionals (osConfig.shell.kde) [
    "L+ /home/jordy/.config/dconf - - - - /home/jordy/.config/dconf-kde"
  ];
}
